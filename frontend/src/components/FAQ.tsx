...
const faqData = [
    {
        id: 1,
        question: 'What is BasicMixer?',
        answer:
            'BasicMixer is a privacy-preserving ETH pool deployed on Sepolia Network. It allows users to deposit a fixed amount of ETH and later withdraw it to a different address without linking the deposit and withdrawal, using zero-knowledge proofs.'
    },
    {
        id: 2,
        question: 'How does BasicMixer preserve privacy?',
        answer:
            'BasicMixer uses zero-knowledge proofs to prove ownership of a deposit without revealing which one, a Poseidon-hashed Merkle tree to store deposits, and nullifiers to prevent double spending without revealing identities.'
    },
    {
        id: 3,
        question: 'What is the deposit amount?',
        answer:
            'Each deposit has a fixed denomination of 0.001 ETH. The total required to deposit is 0.001 ETH.'
    },
    {
        id: 4,
    ...
    },
    {
        ...
        answer:
            'To withdraw, you submit a zero-knowledge proof, a valid Merkle root, your nullifier hash, and a recipient address. If valid, 0.001 ETH is sent to the recipient.'
    },
    {
        id: 10,
        question: 'Can I withdraw to a different wallet?',
        answer:
            'Yes. The withdrawal address does not need to match the deposit address, which is the core privacy feature of BasicMixer.'
    },
    {
        id: 11,
    ...
    },
    {
        ...
        answer:
            'Your funds will be lost permanently. BasicMixer is non-custodial and cannot recover secrets. Always back up your deposit data securely.'
    },
    {
        id: 15,
        question: 'Is BasicMixer non-custodial?',
        answer:
    ...
    },
    {
        ...
        answer:
            'No. There are no protocol fees. The full deposit amount is returned on withdrawal.'
    },
    {
        id: 17,
    ...
    },
    {
        ...
        answer:
            'No. The owner cannot withdraw user deposits. There are no protocol fees.'
    },
    {
        id: 20,
        question: 'What cryptography does BasicMixer use?',
        answer:
            'BasicMixer uses the Poseidon hash function, Merkle trees, and Noir-compatible zero-knowledge proofs, optimized for ZK efficiency.'
    },
    {
        id: 21,
        question: 'Is this production-ready?',
        answer:
            'This deployment is testing-oriented with a 0.001 ETH denomination and should be treated as experimental.'
    },
    {
        id: 22,
        question: 'Where can I use BasicMixer?',
        answer:
            'You can access BasicMixer at https://basicmixer.vercel.app/.'
    },
    {
        id: 23,
        question: 'What network is BasicMixer deployed on?',
        answer:
            'BasicMixer is deployed on Sepolia Network and uses ETH as its native asset.'
    },
    {
        id: 24,
        question: 'Is my privacy guaranteed?',
        answer:
            'BasicMixer provides on-chain privacy, not total anonymity. Privacy depends on the anonymity set, operational security, and withdrawal behavior.'
    }
];
        ...
        <section className="mx-auto px-4 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3 items-center">
                ...
                <p className="text-[12px] sm:text-[13px] text-[#888888] max-w-[520px] text-center">
                    Learn how BasicMixer preserves privacy, how deposits and withdrawals work,
