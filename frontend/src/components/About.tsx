      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-16 lg:gap-20">
        ...
        <div className="flex flex-col gap-4 items-center text-center">
          ...
          <p className="text-[15px] sm:text-[16px] text-[#888888] max-w-2xl leading-relaxed">
            BasicMixer is a privacy-preserving protocol that enables confidential transactions
            on Sepolia Network using zero-knowledge proofs.
          </p>
        </div>
        ...
        <div className="border-l-2 border-white/10 pl-6 sm:pl-8">
          ...
          >
            <div className="flex flex-col gap-4">
              <p>
                BasicMixer breaks the link between deposits and withdrawals using advanced
        ...
        <div className="border-l-2 border-white/10 pl-6 sm:pl-8">
          ...
          >
            <div className="flex flex-col gap-4">
              <p>
                BasicMixer is designed to be fully non-custodial with no protocol fees.
              ...
              <div className="p-5 rounded-xl bg-[#b0b0b0]/5 border border-[#b0b0b0]/15">
                ...
                <p className="text-[12px] text-[#888888]">
                  Fixed deposit amount — no protocol fees
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  {
                    title: 'Non-Custodial',
                    desc: 'No one can access user funds except the depositor'
                  },
                  {
                    title: 'No Fees',
                    desc: 'Full deposit amount is returned on withdrawal'
                  },
                  {
                    title: 'Volume-Based',
          ...
          >
            <div className="flex flex-col gap-2">
              <RoadmapItem
                ...
                description="Deployment on Sepolia with 0.001 ETH denomination. Testing core functionality and ZK proofs."
              />
              ...
              <RoadmapItem
                ...
                status="in-progress"
                title="Mainnet Beta"
                description="Conduct comprehensive security audits and launch a bug bounty program. Deploy to production on the Sepolia Network with enhanced monitoring, followed by a phased increase in deposit limits to ensure stability and risk mitigation."
              />
              ...
              <RoadmapItem
                ...
                description="Support for multiple deposit amounts (0.1 ETH, 1 ETH, 10 ETH) to improve anonymity sets and flexibility."
              />
